...
@onready var b4 = [$Moveables/Coconut4, "CC"]
#Row 3
...
func _on_d_1_button_up() -> void:
	...
	if d1[1] == "E":
		pass
	elif d1[0].get_node("MoveablePanel").get_global_rect().intersedts($Row1.get_global_rect()):
		if a4[0] == $Empty:
			a4[0] = d1[0]
			a4[1] = d1[1]
			d1[0] = $Empty
			...
			d1[0].position = d1_pos
	elif d1[0].get_node("MoveablePanel").get_global_rect().intersedts($Row2.get_global_rect()):
		if b4[0] == $Empty:
			b4[0] = d1[0]
			b4[1] = d1[1]
			d1[0] = $Empty
...
func _on_d_2_button_up() -> void:
	...
	if d2[1] == "E":
		pass
	elif d2[0].get_node("MoveablePanel").get_global_rect().intersedts($Row1.get_global_rect()):
		if a4[0] == $Empty:
			a4[0] = d2[0]
			a4[1] = d2[1]
			d2[0] = $Empty
			...
			d2[0].position = d2_pos
	elif d2[0].get_node("MoveablePanel").get_global_rect().intersedts($Row2.get_global_rect()):
		if b4[0] == $Empty:
			b4[0] = d2[0]
			b4[1] = d2[1]
			d2[0] = $Empty
...
func _on_d_3_button_up() -> void:
	...
	if d3[1] == "E":
		pass
	elif d3[0].get_node("MoveablePanel").get_global_rect().intersedts($Row1.get_global_rect()):
		if a4[0] == $Empty:
			a4[0] = d3[0]
			a4[1] = d3[1]
			d3[0] = $Empty
			...
			d3[0].position = d3_pos
	elif d3[0].get_node("MoveablePanel").get_global_rect().intersedts($Row2.get_global_rect()):
		if b4[0] == $Empty:
			b4[0] = d3[0]
			b4[1] = d3[1]
			d3[0] = $Empty
