	...
	if can_drag:
		...
		if $Panel2.get_global_rect().intersects($"../CastlePannel".get_global_rect()):
			...
			if $"../MiddlePlate/Bottom1".visible:
				...
				can_drag = false
				$".".visible = false
				$"../MiddlePlate/Bottom2".visible = true
				if $"../MiddlePlate/Top1-1".visible:
					$"../MiddlePlate/Top1-1".visible = false
					$"../MiddlePlate/Top1".visible = true
				elif $"../MiddlePlate/Top2-1".visible:
					$"../MiddlePlate/Top2-1".visible = false
					$"../MiddlePlate/Top2".visible = true
		$".".global_position = Vector2(1067.2, 559.55)
